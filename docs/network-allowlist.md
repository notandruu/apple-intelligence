...
Outbound hosts the Apple Intelligence desktop app contacts. For firewall, proxy, and
...
Contacted by every install using Apple Intelligence Cloud (the default after
onboarding).

| Host                                          | Protocol | Port | Purpose                                                                            |
| --------------------------------------------- | -------- | ---- | ---------------------------------------------------------------------------------- |
| `api.apple-intelligence.com`                          | HTTPS    | 443  | Cloud API: transcription, sync, agent reasoning, settings, usage.                  |
| `auth.apple-intelligence.com`                         | HTTPS    | 443  | Account sign-in and session refresh (Better Auth).                                 |
...
Apple Intelligence Cloud routes streaming sessions through one of three providers.
...
| `apple-intelligence.com`        | HTTPS    | 443  | OAuth desktop callback redirect (`/auth/desktop-callback`). |
...
```sh
# Apple Intelligence Cloud reachability
curl -v https://api.apple-intelligence.com/api/health
