...
const CLI_DOCS_URL = "https://docs.apple-intelligence.com/cli/install";
const INSTALL_CMD = "npm install -g @apple-intelligence/cli";
const LOCAL_EXAMPLE = "apple-intelligence --local notes list";
const CLOUD_LOGIN_CMD = "apple-intelligence auth login";
  ...
  return (
    <div className="rounded-lg border border-border/50 dark:border-border-subtle/70 bg-card/50 dark:bg-surface-2/50 backdrop-blur-sm p-4">
      <div className="flex items-center gap-2 mb-4">
        <LogoTile src={logo} alt="Apple Intelligence" />
