...
try {
  ...
  const userDataPath =
    process.platform === "darwin"
      ? path.join(os.homedir(), "Library", "Application Support", "apple-intelligence")
      : process.platform === "win32"
        ? path.join(process.env.APPDATA || os.homedir(), "apple-intelligence")
        : path.join(os.homedir(), ".config", "apple-intelligence");
