...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "com.apple-intelligence.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "apple-intelligence-audio-tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Apple Intelligence Audio Tap",
            kAudioAggregateDeviceUIDKey: "com.apple-intelligence.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "Apple IntelligenceAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
